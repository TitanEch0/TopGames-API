...
*   **🚀 High Performance:** Built on top of OkHttp with built-in support for HTTP caching.
*   **🛡️ Resilient:** Automatic retries with exponential backoff for transient failures.
